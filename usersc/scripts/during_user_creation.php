...
// Save custom join form fields to the users table.
if (isset($theNewId) && $theNewId) {
    $db->update('users', $theNewId, [
        'country'     => Input::get('country'),
        'institution' => Input::get('institution'),
        'skills'      => Input::get('skills'),
        'newsletter'  => Input::get('newsletter') ? 1 : 0,
        'agreement'   => Input::get('agreement')  ? 1 : 0,
    ]);
}
