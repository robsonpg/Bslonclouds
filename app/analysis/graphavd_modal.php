    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modalTitle"><?php echo lang('GRAPHAVD_MODAL_TITLE'); ?></h4>
            </div>
            <div class="container bg-light">
                <div class="row justify-content-between align-items-center">
                    <div class="col">
                        <div id="title_msg">
                            <?php echo lang('MSG_IMAGE_TITLE'); ?>
                            <div>
                ...
                <div class="row">
                    <div class="col">
                        <?php echo lang('NUMBER_POINTS_INPUT'); ?>
                    </div>
                     <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <?php echo lang('STD_DEVIATION_INPUT'); ?>
                    </div>
                    <div class="col">
                ...
                <div class="row">
                    <div class="col d-flex justify-content-center">
                        <div class="card mb-3">
                            <h6 class="card-header"><?php echo lang('GRAPHIC_SPECKLE_TITLE'); ?><a id="image_number"></a>
                                <?php echo lang('GRAPHIC_SPECKLE_TITLE1'); ?>
                            </h6>
                            <div>
                    ...
                    <!--div class="col-1" >
                        <div class="card mb-3">
                            <h6 class="card-header"><?php echo lang('HEATMAP_TITLE'); ?></h6>
                    ...
                    <div class="col-4" >
                        <div class="row">
                            <div class="col align-items-center">
                                <div class="card mb-3">
                                    <h6 class="card-header"><?php echo lang('DISPERSION_TITLE'); ?></h6>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card mb-3">
                                    <h4 class="card-header"><?php echo lang('AVD_TEXT_TITLE'); ?></h4>
                                    <div class="card-body">
                                        <h5 class="card-title"><a id="avd_number">0.00</a><a>&nbsp</a>
                                            <?php echo lang('AVD_TEXT_MSG'); ?><a id="avd_images">[0]</a></h5>
                                        <a href="http://repositorio.ufla.br/jspui/handle/1/12119" target="_blank">
                                            <?php echo lang('AVD_TEXT_MSG_2'); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <a id="ok_avd" class="btn btn-primary" data-bs-dismiss="modal" style="width: 30%"><?php echo lang('BTN_CLOSE'); ?></a>
            </div>
        </div>
    </div>
</div> <!-- /.modal -->
